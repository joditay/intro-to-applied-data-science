...
datasummary((mean + median + sd + min + max) ~ (growth+rgdp60) * ((revolutions > 0) + (revolutions == 0)), data = GrowthSW, output = 'data.frame')
```
...
print(worddoc, target = #docpath in double quotes)
```
